...
def hist1d_gauss(x, mean, loc=0, threshold=1, nbin=20, width=None, hist=True, fontsize=12, color='b', alpha=0.5, title='gaussian fit',
                 ax_thresh=0.2, xlabel='x', ylabel='y', leglabel='data', filename='hist1d_gauss.png') :
...
def hist1d_rayleigh(x, mean, rayleigh_prms={'loc':0, 'scale':[1]}, threshold=1, nbin=None, width=None, hist=True, fontsize=12, color='b', alpha=0.5, title='rayleigh fit',
                    ax_thresh=0.2, xlabel='x', ylabel='y', leglabel='data', filename='hist1d_rayleigh.png') :
