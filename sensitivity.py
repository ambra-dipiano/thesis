...
if plot:
  ...
  for j in range(len(texp)):
    ...
    x = [1, 5, 10, 100]
    y1 = [[3.45734663098577e-11, 1.3048873052446157e-11,7.910828789733936e-12, 1.6811190279480429e-12]]
    y2 = [[3.753193606911769e-09, 1.4165472006456084e-09, 8.587762584435284e-10, 1.824973270427709e-10]]
    y1.append([6.358567480537711e-11, 2.1582881778139934e-11, 1.3048873052454111e-11, 2.7600318180325007e-12])
    y2.append([6.902673455761295e-09, 2.3429740362872147e-09, 1.4165472006464716e-09, 2.9962091973864583e-10])
    l = ['nominal', 'degraded']
    # sens ---!
    plt.figure()
